...
<html>
    ...
    <body>
        ...
        <script>
            ajax("https://api.wordnik.com/v4/words.json/randomWord?hasDictionaryDef=true&maxCorpusCount=-1&minDictionaryCount=1&maxDictionaryCount=-1&minLength=1&maxLength=-1&api_key=f565787c284a1cb8b30070ffaae05715be178a3d2de45fae9", getDefinition);
            ...
            function display(result) {
                ...
                document.querySelector("#definition").appendChild(pWord);
