...
$sql = "SELECT word FROM words
        ...
        WHERE users_has_words.user_id = " . $user_id . "
        ORDER BY word ASC;";
...
<html>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="my-words.php">My Words<span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 flex-item" id="my-words">
                    <h1>My Words</h1>
